    ...
    >
      ...
      {isFinished || isForfeit ? (
        ...
        <div className=" p-3 px-1 min-w-[100px] flex flex-col gap-y-2 justify-center">
          ...
          {isDueDate && !isLive ? (
            <p className=" text-orange text-sm text-center font-semibold">
              Postponed
            </p>
      ...
      )}
       {
            ...
            <Link href={'/gaming'}>
            <div onClick={() => setIsOpen(true)} className=" absolute right-2 top-2 border-2 border-[#2076F8] rounded-lg p-2  " >
