...
const TeamCard = ({ _id, name, category, logo }: Team) => {
	return (
		<Link href={`/team/${_id}`} className='flex max-w-[300px] justify-between cursor-pointer w-full items-center gap-x-2 h-[100px] rounded-md border-2 border-gray p-4 hover:bg-slate-100 duration-500 g-4 m-2'>
